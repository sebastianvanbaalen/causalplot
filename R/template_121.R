# Internal: template implementation for "121"
# Layout: IV(center) -> [M_top, M_bottom] -> DV(center)
.causal_template_121 <- function(
    labels,
    fill_variables,
    fill_mechanisms,
    corner_radius,
  ...
  # Index map: 1=IV, 2=M_top, 3=M_bottom, 4=DV
  boxes <- data.frame(
    xmin  = c(1,  5,  5,  9),
    xmax  = c(3,  7,  7, 11),
    ymin  = c(2.4, 3.8, 1.0, 2.4),
    ymax  = c(3.6, 5.0, 2.2, 3.6),
    label = labels,
