...
- An embedded Shiny app that allows users to make plots without writing
  any code. Launch by typing `causalplot::run_app()` or visit
  <https://sebvanbaalen.shinyapps.io/causalplot>.
